...
public class PaintClientMain extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PaintClientMain frame = new PaintClientMain();
	...
	class Myaction implements ActionListener // 내부클래스로 액션 이벤트 처리 클래스
	{
		...
		public void actionPerformed(ActionEvent e) {
			...
			PaintClientView view = new PaintClientView(username, ip_addr, port_no);
			setVisible(false);
		}
	}
}
